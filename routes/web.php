...
|--------------------------------------------------------------------------
*/
// Routes d'authentification (login uniquement)
...
if ($adminDomain) {
    Route::domain($adminDomain)->group($authRoutes);
} else {
...
if ($frontendDomain) {
    Route::domain($frontendDomain)->group($frontendRoutes);
} else {
