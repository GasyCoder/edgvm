...
<template>
    <AdminLayout>
        <template #header>
            <h1 class="text-lg font-bold text-slate-700">Nouveau membre de jury</h1>
        </template>

        <Head title="Nouveau membre de jury" />
        <FlashMessage />
            ...
            <form class="grid gap-6 lg:grid-cols-3" @submit.prevent="submit">
                ...
                <aside>
                    <div class="rounded-md border border-gray-100 bg-gray-50 p-5 text-xs leading-relaxed text-slate-500">
                        Renseignez l'université et le grade : ces informations apparaissent sur les procès-verbaux et rapports de soutenance.
                    </div>
                </aside>
            </form>
