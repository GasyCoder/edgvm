    ...
    <AdminLayout>
        <template #header>
            <div class="flex flex-wrap items-end justify-between gap-4">
                <div>
                    <h2 class="text-lg font-semibold text-slate-900 md:text-xl">Nouveau doctorant</h2>
                    <p class="mt-1 text-xs text-slate-500 md:text-sm">Renseignez les informations administratives.</p>
                </div>
        ...
        <section class="rounded-2xl border border-slate-200 bg-white p-6">
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div>
                    <h3 class="text-sm font-semibold text-slate-700">Import Excel</h3>
                    <p class="mt-1 text-xs text-slate-500">Importez plusieurs doctorants en une fois.</p>
                </div>
            ...
            <p class="mt-2 text-xs text-slate-500">Formats acceptes: .xlsx, .xls</p>
        </section>
        ...
        <form class="grid gap-6 lg:grid-cols-3" @submit.prevent="submit">
            ...
            <aside class="space-y-6">
                ...
                <section class="rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-5 text-xs text-slate-600">
                    Astuce: la date d'inscription sert au suivi statistique et aux rapports.
                </section>
            </aside>
        </form>
