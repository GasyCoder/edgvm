            ...
            >
                <template #actions>
                    <Link
                        ...
                        class="group relative inline-flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 text-slate-600 transition hover:border-slate-300 hover:bg-slate-50"
                        title="Exporter"
                    >
                    ...
                    <Link
                        ...
                        class="group relative inline-flex h-10 w-10 items-center justify-center rounded-xl bg-ed-primary text-white shadow-sm transition hover:bg-ed-secondary"
