...
<template>
    <AdminLayout>
        ...
        <div class="space-y-4">
            ...
            >
                <template #actions>
                    <Link :href="route('admin.ead.create')" class="inline-flex items-center gap-2 rounded-xl bg-ed-primary px-4 py-2.5 text-sm font-semibold text-white hover:bg-ed-secondary">
                            ...
                            <tr v-for="ead in eads.data" :key="ead.id" class="hover:bg-slate-50">
                                ...
                                <td class="px-5 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        <Link :href="route('admin.ead.edit', ead.slug)" class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-100">
                                        ...
                                        <button type="button" class="inline-flex items-center gap-1.5 rounded-lg border border-red-200 px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-50" @click="deleteEad(ead)">
                                            <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
