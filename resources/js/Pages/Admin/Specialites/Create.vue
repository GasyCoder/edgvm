    ...
    <AdminLayout>
        <template #header>
            <div class="flex flex-wrap items-end justify-between gap-4">
                <div>
                    <h2 class="text-lg font-semibold text-slate-900 md:text-xl">Creer une specialite</h2>
                    <p class="mt-1 text-xs text-slate-500 md:text-sm">Associez la specialite a un EAD.</p>
                </div>
        ...
        <Head title="Creer une specialite" />
        <FlashMessage />
        ...
        <form class="grid gap-6 lg:grid-cols-3" @submit.prevent="submit">
            ...
            <aside class="space-y-6">
                ...
                <section class="rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-5 text-xs text-slate-600">
                    Astuce: choisissez l'EAD pour lier automatiquement les theses a la specialite.
                </section>
            </aside>
        </form>
