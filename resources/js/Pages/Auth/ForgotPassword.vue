    ...
    <AuthLayout>
        ...
        <div class="mx-auto w-full max-w-md">
            <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                <div class="space-y-2">
                    <p class="text-xs font-semibold uppercase tracking-wide text-ed-primary">Réinitialisation</p>
                    <h1 class="text-2xl font-semibold text-slate-900">Mot de passe oublié</h1>
                    <p class="text-sm text-slate-500">Recevez un lien sécurisé pour réinitialiser votre mot de passe.</p>
                </div>

                <p v-if="props.status" class="mt-6 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700">
                    {{ props.status }}
                </p>
