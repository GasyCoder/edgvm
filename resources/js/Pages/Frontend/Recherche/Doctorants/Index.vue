...
<template>
    ...
    <div>
                        ...
                        <div class="flex flex-wrap md:flex-nowrap items-end gap-3 md:gap-4">
                            <div class="w-full sm:w-auto">
                                ...
                                <select
                                    ...
                                    class="px-3 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent w-full sm:w-auto"
                                >
                                    <option value="">Tous les statuts de these</option>
                            ...
                            <div class="w-full sm:w-auto">
                                ...
                                <select
                                    v-model="filterEad"
                                    class="px-3 py-2.5 text-xs md:text-sm rounded-lg border border-gray-200 bg-white focus:ring-2 focus:ring-ed-primary/60 focus:border-transparent min-w-[170px] w-full sm:w-auto"
                                >
                            ...
                            <div class="w-full sm:w-auto">
                                ...
                                <div class="flex bg-gray-100 rounded-full p-1 w-fit">
                                    <button
                                        type="button"
                                        class="px-3 py-1.5 rounded-full text-xs md:text-sm flex items-center gap-1 transition"
                            ...
                            <div v-if="search || filterStatut || filterEad" class="w-full sm:w-auto md:ml-auto">
                                <button
                                    type="button"
                                    class="inline-flex items-center gap-1 px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs md:text-sm font-semibold rounded-lg transition w-full sm:w-auto justify-center md:justify-start"
                                    @click="resetFilters"
                                >
        ...
        <section class="py-8 bg-gradient-to-b from-gray-50 to-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div v-if="!doctorants?.data?.length" class="text-center py-16">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Aucun doctorant trouve</h3>
                    <p class="text-gray-600 mb-4">Essayez de modifier vos criteres de recherche ou de reinitialiser les filtres.</p>
                    ...
                    <div v-if="viewMode === 'grid'" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        ...
                        >
                            <div class="relative bg-gradient-to-br from-ed-primary via-ed-secondary to-emerald-700 h-20 flex items-center justify-center">
                                ...
                                <div v-if="doctorant.badge" class="absolute top-2 right-2">
                                    <span class="px-2 py-0.5 rounded-full text-[11px] font-semibold text-white shadow-sm" :class="doctorant.badge.class">
                            ...
                            <div class="p-4">
                                ...
                                <p v-if="doctorant.matricule" class="text-xs text-gray-500 mb-2">
                                    Matricule : {{ doctorant.matricule }}
                                </p>

                                <div v-if="doctorant.these_principale" class="space-y-1.5 text-xs">
                                    <div v-if="doctorant.these_principale.specialite" class="flex items-start gap-1.5">
                                    ...
                                    <div v-if="doctorant.these_principale.ead" class="flex items-start gap-1.5">
                                ...
                                <p v-else class="text-xs text-gray-400 italic mt-1">Aucune these renseignee</p>
                    ...
                    <div v-else class="space-y-3">
                        ...
                        >
                            <div class="relative flex-shrink-0">
                                ...
                                <span v-if="doctorant.badge" class="absolute -bottom-1 -right-1 px-2 py-0.5 text-[11px] rounded-full text-white font-semibold border-2 border-white" :class="doctorant.badge.class">
                                    {{ doctorant.badge.text }}
                                </span>
                            </div>
