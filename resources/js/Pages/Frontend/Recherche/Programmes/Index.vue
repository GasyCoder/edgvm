    ...
    <div>
        ...
        <section class="py-12 bg-gradient-to-b from-gray-50 to-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- En-tete -->
                <div class="flex items-center justify-between gap-4 pb-4 mb-6 border-b-2 border-gray-300">
                    <span class="text-base font-bold text-gray-700 uppercase tracking-wide">Nom</span>
                    <span class="text-base font-bold text-gray-700 uppercase tracking-wide">EAD</span>
                </div>
                ...
                <ul v-else class="space-y-4">
                    ...
                    >
                        <span class="flex items-center gap-3 text-lg text-gray-900">
                            <span class="w-2.5 h-2.5 rounded-full bg-ed-primary flex-shrink-0"></span>
                            {{ specialite.nom }}
                        </span>
                        <span v-if="specialite.ead" class="text-base text-gray-600 text-right flex-shrink-0">
                            {{ specialite.ead }}
                        </span>
                    </li>
                </ul>
