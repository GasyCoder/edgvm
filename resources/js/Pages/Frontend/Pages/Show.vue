    ...
    <div>
        <section class="relative gradient-primary pt-24 md:pt-28 pb-16 md:pb-20 overflow-hidden">
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="max-w-3xl">
                    ...
                    <p v-if="page?.updated_at" class="text-white/80 text-xs md:text-sm flex items-center gap-2">
        ...
        <section class="relative bg-gradient-to-b from-gray-50 to-white pb-16 pt-6 md:pt-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div v-if="!hasContent" class="-mt-16 md:-mt-20">
                ...
                <div v-else class="-mt-16 md:-mt-20">
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div class="lg:col-span-2 space-y-10">
                            <article v-if="page?.contenu" class="bg-white rounded-2xl shadow-xl p-6 md:p-10 border border-gray-100">
                                ...
                                <div class="prose prose-indigo max-w-none text-justify leading-relaxed" v-html="page.contenu"></div>
                            </article>

                            <div v-if="page?.sections?.length" class="space-y-10">
                                <section
                                ...
                                >
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-0" v-if="section.image_url">
                                        <div
                                            class="relative h-64 md:h-72 lg:h-full overflow-hidden group"
                                        ...
                                        <div class="p-6 md:p-10 flex flex-col justify-center" :class="section.index % 2 === 0 ? '' : 'lg:order-1'">
                                            <h2 v-if="section.titre" class="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6 flex items-center gap-3">
                                            ...
                                            <div v-if="section.contenu" class="prose prose-gray max-w-none text-justify leading-relaxed" v-html="formatText(section.contenu)"></div>
                                        </div>
                                    </div>

                                    <div v-else class="bg-white rounded-2xl shadow-xl p-6 md:p-10 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
                                        <h2 v-if="section.titre" class="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6 flex items-center gap-3">
                                        ...
                                        <div v-if="section.contenu" class="prose prose-lg prose-gray max-w-none text-justify leading-relaxed" v-html="formatText(section.contenu)"></div>
                                    </div>
                                </section>
                            </div>
                        </div>
