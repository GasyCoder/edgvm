@if($partenaires->count() > 0)
    ...
    <section class="py-14 bg-gradient-to-b from-white via-slate-50 to-white border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {{-- En-tête : gauche sur desktop / centré sur mobile --}}
            <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-5 mb-10">
                ...
                {{-- (Optionnel) un petit indicateur à droite, léger et pro --}}
            ...
            >
                ...
                @if($slides->count() > 1)
                    <button
                        ...
                        aria-label="Partenaires précédent"
                    >
            ...
            {{-- CTA Devenir partenaire (votre version, inchangée) --}}
