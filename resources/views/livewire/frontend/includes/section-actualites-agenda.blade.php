{{-- resources/views/livewire/frontend/includes/section-actualites-agenda.blade.php --}}
                                        ...
                                        <div class="flex flex-wrap items-center gap-1.5 mt-1">
                                            ...
                                            @if($evenement->lieu)
                                                <span class="inline-flex items-center gap-1 text-[10px] text-gray-500">
                                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                              d="M17.657 16.657L13.414 20.9a1 1 0 01-1.414 0L6.343 15.243a8 8 0 111.314-11.314 8 8 0 0111.314 11.314z"/>
                                                    </svg>
