<div>
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 py-16 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <nav class="mb-6">
                <ol class="flex items-center gap-2 text-xs text-white/70">
                    ...
                    <li>›</li>
                    <li><a href="{{ route('ead') }}" class="hover:text-white transition">EAD</a></li>
                    <li>›</li>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach($ead->theses as $these)
                            <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                <div class="w-12 h-12 bg-gradient-to-br from-ed-primary to-ed-secondary rounded-full flex items-center justify-center flex-shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 text-sm">
                                        {{ $these->doctorant->nom }} {{ $these->doctorant->prenom }}
                                    </p>
                                    <p class="text-xs text-gray-600 line-clamp-2">{{ $these->titre }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
