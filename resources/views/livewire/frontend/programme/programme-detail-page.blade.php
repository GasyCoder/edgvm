<div>
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-br from-ed-primary via-ed-secondary to-purple-600 py-16 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <nav class="mb-6">
                <ol class="flex items-center gap-2 text-xs text-white/70">
                    ...
                    <li>›</li>
                    <li><a href="{{ route('programmes') }}" class="hover:text-white transition">Programmes</a></li>
                    <li>›</li>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl shadow-xl p-8">
                        ...
                        <!-- Doctorants en cours -->
                        @if($specialite->theses->isNotEmpty())
                        <div class="mb-8">
                            <h3 class="text-xl font-bold text-gray-900 mb-4">Doctorants en cours</h3>
                            <div class="space-y-3">
                                @foreach($specialite->theses as $these)
                                <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                    <div class="w-12 h-12 bg-ed-primary rounded-full flex items-center justify-center flex-shrink-0">
                                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
                                        </svg>
                                    </div>
                                    <div class="flex-1">
                                        <p class="font-semibold text-gray-900">{{ $these->doctorant->nom }} {{ $these->doctorant->prenom }}</p>
                                        <p class="text-sm text-gray-600 line-clamp-1">{{ $these->titre }}</p>
                                    </div>
                                </div>
                                @endforeach
                            </div>
