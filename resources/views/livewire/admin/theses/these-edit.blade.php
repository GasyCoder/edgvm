<div>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Modifier la thèse</h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form wire:submit.prevent="save">
                <div class="bg-white rounded-xl shadow-lg p-8 space-y-8">
                    ...
                    {{-- SECTION DOCTORANT (non modifiable) --}}
                    <div class="border-b border-gray-200 pb-6">
                                ...
                                <div class="flex-1">
                                    ...
                                    @if($these->sujet_these)
                                        <p class="text-xs text-gray-500 mt-1">
                                            Sujet actuel : {{ $these->sujet_these }}
                                        </p>
                                    @endif
                                </div>
                            </div>
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            ℹ️ Le doctorant ne peut pas être modifié après la création de la thèse.
                        </p>
                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="resume_these"
                                      ...
                                      placeholder="Résumé scientifique de la thèse..."></textarea>
                            @error('resume_these')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Ex : changement climatique, Boeny, pesticides, etc.">
                            @error('mots_cles')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        @if($these->fichier)
                            <div class="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg text-sm">
                                ...
                                <p class="text-green-700">
                                    <a href="{{ $these->fichier->url }}" target="_blank" class="underline">
                        ...
                        <div class="space-y-3">
                            <div>
                                <label for="media" class="block text-sm font-bold text-gray-700 mb-2">
                                    Remplacer ou ajouter un fichier PDF <span class="text-gray-400">(optionnel)</span>
                                </label>
                                <input type="file"
                                    id="media"
                                    wire:model="media"
                            ...
                            <div class="flex items-center gap-3">
                                <span class="text-xs text-gray-500">
                                    Vous pouvez importer un nouveau PDF ou choisir un fichier déjà présent dans la médiathèque.
                                </span>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                @if($media_id)
                                    <p class="mt-2 text-xs text-green-700">
                                        ✅ Un fichier est sélectionné (ID : {{ $media_id }}).
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <ul class="text-sm text-blue-700 mt-1 list-disc list-inside space-y-1">
                                    <li>Le doctorant est fixé, mais toutes les métadonnées de la thèse sont modifiables.</li>
                                    <li>Le PDF peut être remplacé sans supprimer l’ancien dans la médiathèque.</li>
                                    <li>Les informations de publication (université, date, résumé, mots-clés) sont utiles pour l’archivage et la diffusion.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-semibold text-gray-900 truncate">
                                                {{ \Illuminate\Support\Str::limit($doc->nom_original, 40) }}
                                            </p>
